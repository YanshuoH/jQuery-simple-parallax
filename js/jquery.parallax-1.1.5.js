...
(function( $ ){
    ...
    $.fn.parallax = function(name, speedFactor, outerHeight) {
        ...
        // handle background-position-x(y) case for firefox
        // And all specific fix shall be put here
        if ($this.css(name) === undefined) {
            switch(name) {
                case 'background-position-x':
                        originalValue = $this.css('background-position');
                    break;
